...
contextMenu.album = function (albumID, e) {
    ...
    let items = [
        ...
        {
            title: build.iconic('collapse-left') + 'Merge', fn: () => {
                basicContext.close();
        ...
        },
        {
            title: build.iconic('folder') + 'Move', fn: () => {
                basicContext.close();
                contextMenu.moveAlbum([albumID], e)
            }
        },
...
contextMenu.albumMulti = function (albumIDs, e) {
    ...
    let items = [
        ...
        {
            title: build.iconic('collapse-left') + 'Merge', visible: !autoMerge, fn: () => {
                basicContext.close();
        ...
        },
        {
            title: build.iconic('folder') + 'Move All', fn: () => {
                basicContext.close();
                contextMenu.moveAlbum(albumIDs, e)
            }
        },
...
contextMenu.photoMulti = function (photoIDs, e) {
    ...
    multiselect.stopResize();// Notice for 'Move All':
    // fn must call basicContext.close() first,
